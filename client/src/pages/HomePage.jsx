      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white text-lg px-10 py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl inline-flex items-center gap-3 animate-slide-up"
        ...
        <div className="text-center mt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              onClick={() => navigate('/analyze')}
              className="bg-white text-primary-600 border-2 border-primary-600 hover:bg-primary-50 text-lg px-10 py-4 rounded-xl font-semibold transition-colors inline-flex items-center gap-3"
            >
              <FaRocket /> Try AI Analysis
            </button>
          </div>
        </div>
      </div>
