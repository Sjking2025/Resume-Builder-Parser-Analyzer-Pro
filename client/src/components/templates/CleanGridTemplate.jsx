        ...
        <div style={styles.headerTop}>
          ...
          <div style={styles.contact}>
            ...
            {personalInfo.linkedin && (
              <div>
                LinkedIn: <a href={personalInfo.linkedin} style={styles.contactLink}>{exportMode === 'digital' ? personalInfo.linkedin : 'LinkedIn Profile'}</a>
              </div>
            )}
            {personalInfo.github && (
              <div>
                GitHub: <a href={personalInfo.github} style={styles.contactLink}>{exportMode === 'digital' ? personalInfo.github : 'GitHub Profile'}</a>
              </div>
            )}
